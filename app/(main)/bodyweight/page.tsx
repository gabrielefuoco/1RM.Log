...
export default function BodyweightPage() {
    ...
    const chartData = [...history].reverse().map(log => ({
        weight: log.weight,
        date: format(new Date(log.date), "d MMM", { locale: it }),
    ...
    return (
        <div className="space-y-6 pb-20">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-heading font-black tracking-tight uppercase">Peso Corporeo</h1>
                    <p className="text-xs text-muted-foreground font-bold tracking-widest uppercase">Tracciamento e Analisi</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Card className="bg-secondary/5 border-border/40">
                    <CardContent className="pt-4 px-4 pb-3">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Attuale</p>
                ...
                <Card className="bg-secondary/5 border-border/40">
                    <CardContent className="pt-4 px-4 pb-3">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Variazione</p>
                ...
                <Card className="bg-secondary/5 border-border/40">
                    <CardContent className="pt-4 px-4 pb-3">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Minimo</p>
                        <div className="flex items-baseline gap-1">
                ...
                <Card className="bg-secondary/5 border-border/40">
                    <CardContent className="pt-4 px-4 pb-3">
                        <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-wider mb-1">Massimo</p>
                        <div className="flex items-baseline gap-1">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <Card className="lg:col-span-1 border-border/40 bg-card/30">
                    <CardHeader>
                        <CardTitle className="text-sm font-bold tracking-tight uppercase">Nuova Registrazione</CardTitle>
                    </CardHeader>
                ...
                <Card className="lg:col-span-2 border-border/40 bg-card/30">
                    <CardHeader className="flex flex-row items-center justify-between">
                        <CardTitle className="text-sm font-bold tracking-tight uppercase">Storico Logs</CardTitle>
                        <p className="text-[10px] font-bold text-muted-foreground uppercase">{history.length} voci</p>
                    </CardHeader>
                        ...
                        <div className="divide-y divide-border/10">
                            {history.length === 0 ? (
                                <div className="py-12 text-center text-muted-foreground">
                                    ...
                                    <p className="text-xs font-bold uppercase tracking-widest">Nessun log trovato</p>
                                </div>
                            ) : (
                                history.map((log) => (
