    ...
    return (
        <div className="space-y-6 pb-20">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                            {isLoading ? (
                                ...
                                <>
                                    <h3 className="font-bold text-lg leading-none">{profile?.full_name || "Atleta"}</h3>
                ...
                <CardContent className="space-y-4">
                    <div className="flex items-center justify-between">
                        <div className="space-y-0.5">
                            <h4 className="font-medium text-sm text-slate-200">Tema</h4>
            ...
            <div className="text-center text-xs text-muted-foreground pt-10">
                <p>1RM Logbook v0.1.0</p>
                <p>Designed for Powerlifting & Bodybuilding</p>
            </div>
        </div>
    )
}
