...
export default function RecapPage({ params }: { params: Promise<{ sessionId: string }> }) {
    ...
    useEffect(() => {
        const loadRecap = async () => {
            try {
                ...
                console.error(e)
                toast.error("Errore caricamento riepilogo")
            } finally {
                setLoading(false)
            }
        }
    ...
    const handleFinish = async () => {
        ...
        try {
            ...
            console.error(e)
            toast.error("Errore durante il salvataggio finale")
        } finally {
            setIsSaving(false)
        }
    }
    ...
    if (!recapData) return <div className="h-screen flex items-center justify-center text-white">Dati non trovati</div>
    ...
    return (
        <div className="min-h-screen bg-background text-foreground pb-24">
            ...
            <div className="relative overflow-hidden bg-muted/20 border-b border-border/50 px-6 pt-12 pb-8 text-center space-y-2">
                ...
                <h1 className="text-3xl font-black uppercase tracking-tighter text-white italic">Allenamento Completato!</h1>
            ...
            <div className="p-6 space-y-8 max-w-lg mx-auto">
                ...
                {prs.length > 0 && (
                    <div className="space-y-4">
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="text-xs font-black uppercase tracking-widest text-primary">Nuovi Record Personali</h2>
                        </div>
                            ...
                            {prs.map((pr: any, i: number) => (
                                <div key={i} className="bg-muted/40 border border-primary/30 rounded-2xl p-4 relative overflow-hidden group">
                                    ...
                                    <div className="relative z-10 flex items-center justify-between">
                                        <div>
                                            <p className="text-[10px] text-primary uppercase font-black tracking-widest mb-0.5">EST. 1RM RECORD</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="bg-muted/30 border border-border rounded-2xl p-4 space-y-1">
                        <div className="flex items-center gap-2 text-muted-foreground mb-2">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest">Volume Totale</span>
                        </div>
                    ...
                    <div className="bg-muted/30 border border-border rounded-2xl p-4 space-y-1">
                        <div className="flex items-center gap-2 text-muted-foreground mb-2">
                            ...
                            <span className="text-[9px] font-black uppercase tracking-widest">Reps Totali</span>
                        </div>
                        <div className="flex items-end gap-2">
                ...
                <div className="bg-muted/20 border border-border/50 rounded-2xl p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <p className="text-[9px] text-muted-foreground uppercase font-black tracking-widest">Durata Sessione</p>
                ...
                <div className="space-y-6 pt-4 border-t border-border/50">
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <h2 className="text-xs font-black uppercase tracking-widest text-white">Difficoltà Sessione (RPE)</h2>
                            <span className={cn(
                                "text-lg font-black",
                    ...
                    <div className="space-y-2">
                        <h2 className="text-xs font-black uppercase tracking-widest text-white">Note Sessione</h2>
                        <Textarea
                            placeholder="Come ti sei sentito oggi? Qualche esercizio in particolare?"
                            value={notes}
